To calculate the forecast error variance decomposition (FEVD) in the sequence space, I start with the moving average process from \textcite{auclert2021using}
\[
